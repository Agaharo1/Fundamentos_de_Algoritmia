...
### 3. 🔙 Vuelta Atrás (Backtracking)
Implementación de algoritmos de búsqueda exhaustiva para encontrar soluciones óptimas o contar todas las soluciones posibles a un problema (ej. problemas de combinatoria, laberintos, N-reinas).
...
---
*Repositorio creado para la asignatura de Fundamentos de Algoritmia.*
